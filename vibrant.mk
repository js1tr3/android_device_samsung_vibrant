...
PRODUCT_COPY_FILES := \
	device/samsung/vibrant/vold.fstab:system/etc/vold.fstab \
	device/samsung/vibrant/egl.cfg:system/lib/egl/egl.cfg

# Init files
PRODUCT_COPY_FILES += \
	device/samsung/vibrant/init.aries.rc:root/init.aries.rc \
	device/samsung/vibrant/ueventd.aries.rc:root/ueventd.aries.rc \
        device/samsung/vibrant/recovery.rc:root/recovery.rc

# Recovery Files
PRODUCT_COPY_FILES += \
	device/samsung/vibrant/init.aries.rc:recovery/root/init.aries.rc \
	device/samsung/vibrant/ueventd.aries.rc:recovery/root/ueventd.aries.rc \
        device/samsung/vibrant/recovery.rc:recovery/root/recovery.rc

# Prebuilt kl keymaps
PRODUCT_COPY_FILES += \
	device/samsung/vibrant/cypress-touchkey.kl:system/usr/keylayout/cypress-touchkey.kl \
	device/samsung/vibrant/sec_jack.kl:system/usr/keylayout/sec_jack.kl \
	device/samsung/vibrant/s3c-keypad.kl:system/usr/keylayout/s3c-keypad.kl
...
PRODUCT_COPY_FILES += \
	device/samsung/vibrant/secomxregistry:system/etc/secomxregistry \
...
PRODUCT_COPY_FILES += \
	device/samsung/vibrant/mxt224_ts_input.idc:system/usr/idc/mxt224_ts_input.idc
...
# kernel modules
PRODUCT_COPY_FILES += \
	device/samsung/vibrant/bcm4329.ko:system/modules/bcm4329.ko \
	device/samsung/vibrant/cifs.ko:system/modules/cifs.ko \
	device/samsung/vibrant/tun.ko:system/modules/tun.ko

ifeq ($(TARGET_PREBUILT_ZIMAGE),)
LOCAL_ZIMAGE := device/samsung/vibrant/zImage
else
